...
bool PhysicsActor::GravityCheck(float _DeltaTime)
{
	...
	Color8Bit Color_Right = MarioHelper::ColMapImage->GetColor(GetActorLocation().iX() + 30.f, GetActorLocation().iY(), Color8Bit::MagentaA);
	Color8Bit Color_Left = MarioHelper::ColMapImage->GetColor(GetActorLocation().iX() - 30.f, GetActorLocation().iY(), Color8Bit::MagentaA);
